...
export default function HeroSection({
  ...
  return (
    ...
    <section className="bg-gradient-to-b from-white to-[#FFF7ED] pb-0 pt-16 sm:pt-20">
      ...
      <div className="mx-auto max-w-5xl px-4 pb-12 pt-4 sm:pb-16">
        <div className="grid items-center gap-8 md:grid-cols-[3fr_2fr] md:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <h1
              className="max-w-[520px] text-[2.5rem] font-[800] leading-[1.15] tracking-tight text-[#0B0F1A] md:text-[3.5rem]"
            ...
            >
              <Link
                ...
                className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-[#F4A261] px-6 py-3 text-[15px] font-[600] text-[#0B0F1A] shadow-none transition-all duration-150 hover:bg-[#E58B3A] hover:shadow-sm active:scale-95"
              >
                {primaryCta.label}
              </Link>
              <Link
                href={secondaryCta.href}
                className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-[#EADFD3] bg-white px-6 py-3 text-[15px] font-[600] text-[#111827] transition-all duration-150 hover:border-[#DFD1C4] hover:bg-[#FFF7ED]"
              >
                {secondaryCta.label}
              </Link>
            </div>
